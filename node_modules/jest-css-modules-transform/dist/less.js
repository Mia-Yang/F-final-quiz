...
const render = (prependedContent) => {
    less_1.default.render(`${prependedContent}${fs_1.readFileSync(filePath, { encoding: 'utf-8' })}`, Object.assign(utils_1.getPreProcessorsConfig(configPath).lessConfig || {}, { filename: filePath })).then(({ css }) => {
